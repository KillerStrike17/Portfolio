...
const Speaking = () => {
  const events = [
...

    {
      ...
      event: "Analytics India Managize National Developer Conference",
    ...
    {
      id: "cloud-commmunity-day-bengaluru-2025",
    ...
    {
      id: "cloud-commmunity-day-mumbai-2025",
    ...
    {
      id: "asia-tech-x-singapore-techxlr8-aisa-2025",
